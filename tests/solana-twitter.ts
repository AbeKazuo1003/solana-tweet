...
describe("solana-twitter", () => {
    ...
    it('can send a new tweet', async () => {
        ...
        await program.rpc.sendTweet('veganism', 'Humans, am I right?', {
            accounts: {
    ...
    it('cannot provide a topic with more than 50 characters', async () => {
        try {
            ...
            assert.equal(error.msg, 'Topic Max length is 50');
            return;
        }
    ...
    it('cannot provide a content with more than 280 characters', async () => {
        try {
            ...
            assert.equal(error.msg, 'Content Max length is 280');
            return;
        }
    ...
    it('can filter tweets by author', async () => {
        ...
        assert.ok(tweetAccounts.every(tweetAccounts => {
            return tweetAccounts.account.author.toBase58() === authorPublicKey.toBase58()
        }))
    });
